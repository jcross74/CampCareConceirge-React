...
const comments = [
  {
    ...
    login: "@ethel",
    time: "1h",
    content: "On <strong>Roblox Camp</strong>",
  ...
  },
  {
    ...
    login: "@jaz.designer",
    time: "8h",
    content: "On <strong>Soccer Kids United</strong>",
    comment: "I need this for the Summer please!",
  ...
  },
  {
    ...
    login: "@ethel",
    time: "1h",
    content: "On <strong>FitKids</strong>",
    comment: "How can I register?",
